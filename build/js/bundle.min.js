function eventListeners(){document.querySelector(".mobil-menu").addEventListener("click",functionnavegacionResponsive)}function functionnavegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
